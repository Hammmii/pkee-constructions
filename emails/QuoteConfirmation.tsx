...
export type QuoteSummaryRow = { label: string; value: string };
...
/**
 * Customer confirmation — branded (ink/bone/brass), reference number up top,
 * summary of what they told us, and the response-time promise.
 */
export function QuoteConfirmationEmail({
  reference,
  name,
  rows,
}: QuoteConfirmationEmailProps): ReactElement {
  ...
  return (
    <Html lang="en-CA">
      <Head />
      <Preview>
        We received your request — reference {reference}. We reply within 2 business days.
      </Preview>
        ...
        <Container style={{ maxWidth: 560, margin: "0 auto", padding: "40px 24px" }}>
          <Section>
            ...
            <Text style={{ color: ink, fontSize: 15, lineHeight: 1.6, margin: "12px 0 0" }}>
              Your project request is in. Keep this reference number — our team will use it in every
              follow-up.
            </Text>
            <Text
              style={{
          ...
          <Section>
            ...
            <Text style={{ color: ink, fontSize: 15, lineHeight: 1.6, margin: 0 }}>
              A specialist reviews your project details and responds within{" "}
              <strong>2 business days</strong> — usually sooner. If anything about the request
              changes, just reply to this email and reference {reference}.
            </Text>
          </Section>
